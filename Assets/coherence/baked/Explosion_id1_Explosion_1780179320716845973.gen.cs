...
namespace Coherence.Generated
{
	...
	public struct Explosion_id1_Explosion_1780179320716845973 : ICoherenceComponentData
	{
		...
		{
			var other = (Explosion_id1_Explosion_1780179320716845973)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		public static void Serialize(Explosion_id1_Explosion_1780179320716845973 data, uint mask, IOutProtocolBitStream bitStream)
		{
		...
		{
			var mask = (uint)0;
			var val = new Explosion_id1_Explosion_1780179320716845973();
		...
		{
			var last = lastSent as Explosion_id1_Explosion_1780179320716845973?;
